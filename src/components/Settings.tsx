        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.title}>
                    <Text style={styles.name}>RandomizeFileName</Text>
            ...
            <FormSection title="SETTING">
                <FormInput
                    ...
                    placeholder="split extensions with '|' (e.g. js|json|png)"
                    value={settings.get("exts")}
                    onSubmitEditing={(event) => {
                        settings.set("exts", event.nativeEvent.text)
                    }}
                />
            </FormSection>
            <FormSection title="INFORMATION">
                ...
                <FormRow
                    ...
                    onPress={() => {
                        Linking.openURL("https://github.com/m4fn3/RandomizeFileName")
                    }}
                />
            </FormSection>
